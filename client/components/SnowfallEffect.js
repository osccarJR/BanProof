...
function createSnowflake() {
    ...
    snowflake.style.animationDuration = Math.random() * 8 + 16 + "s"; // Duración aleatoria entre 5s y 10s
    snowflake.style.fontSize = Math.random() * 15 + 5 + "px"; // Tamaño aleatorio entre 10px y 30px
